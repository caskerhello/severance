...
<script type="text/javascript">
	...
	function timeTableMaker(selectedMonth, selectedDate) {
		...
		const timeRow = timeTable.insertRow();
		timeRow.classList.add("timeTableRow");  // flexbox를 사용할 클래스 추가
		...
		for (i = 0; i < 2; i++) {
			...
			cell.classList.add("timeButtonCell");

			cell.style.borderStyle = 'solid';
			cell.style.borderWidth = '1px';
			cell.style.borderColor = '#C6C6C6';

			let selectedFirstTime = null;
			let cellTime = null;
	...
	function submitRes() {
		...
		var inputField = document.querySelector('input[name="docsection"]');
		// 불러온 값의 앞뒤 공백을 제거
	...
	<div class="mainBox">
		<div class="contentBox">
			...
			<form action="reservation" method="post" name="reservationform">
				<%--			<div class="textLeft"><span style="color: #505050; font-size:40px; font-weight:700; margin: 0 auto">예약하기</span></div>--%>
	...
	<div class="doccontainer">
			...
			<div class="contact-box2">
				...
				<div class="right3">
					<h2>의사 프로필</h2>
					<div class="abc3">
						<input type="text" class="field3" name="docname" value="${detail.name}" readonly/>
					</div>

					<div class="abc3">
						<input type="text" class="field3" name="docsection"
							   value="<c:choose>
									<c:when test='${detail.doctorsection == 1}'>정형외과</c:when>
									<c:when test='${detail.doctorsection == 2}'>이비인후과</c:when>
									<c:when test='${detail.doctorsection == 3}'>외과</c:when>
									<c:when test='${detail.doctorsection == 4}'>산부인과</c:when>
									<c:when test='${detail.doctorsection == 5}'>비뇨기과</c:when>

              						</c:choose>"
							   style="text-indent: 10px; text-align: left !important; padding-left: 5px !important;" readonly/>
					</div>

					<div class="abc4">
						<input type="text" class="field4" name="docbachd" value="${detail.bachd}" readonly/>
						<input type="text" class="field4" name="docmastd" value="${detail.mastd}" readonly/>
						<input type="text" class="field4" name="docdoctd" value="${detail.doctd}" readonly/>
						<input type="text" class="field4" name="docresume" value="${detail.resume}" readonly/>
					</div>
					...
					<div class="doccontainer">
						...
						<div class="contact-box2">
							...
							<div class="left3">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3162.691083294709!2d126.93829427643024!3d37.56234132436778!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357c988fb8086133%3A0x760d3f98106f3696!2z7IS467iM656A7Iqk67OR7JuQ!5e0!3m2!1sko!2skr!4v1733895653841!5m2!1sko!2skr" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							</div>
							...
							<div class="right3">
								...
								<div class="abc3">
									<input type="text" class="field3" name="membername" value="${mvo.name}" readonly/>
								</div>

								<div class="abc3">
									<input type="text" class="field3" name="memberphone" value="${mvo.phone}" readonly/>
								</div>

								<div class="abc3">
									<input type="text" class="field3" name="memberemail" value="${mvo.email}" readonly/>
								</div>

								<div class="abc3">
									<input type="text" class="field3" name="memberaddress" value="${mvo.address}" readonly/>
								</div>
							</div>
						...
						<div class="contact-box3">
							...
							<div class="left4">
								...
								<div class="timeselect">
									...
									<span><button class="btnTime" type="button" id="btn_init" onclick="tableinit()">시간초기화</button></span>
